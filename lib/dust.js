...
function Context(global, stack, blocks) {
  this.global = global;
...
Context.wrap = function(context) {
  ...
  return new Context(null,new Stack(context));
}
...
Context.prototype.push = function(head, idx, len) {
  return new Context(this.global, new Stack(head, this.stack, idx, len), this.blocks);
};

Context.prototype.rebase = function(head) {
  return new Context(this.global, new Stack(head), this.blocks);
};
...
Context.prototype.shiftBlocks = function(locals) {
  ...
  if (locals) {
    ...
    return new Context(this.global, this.stack, newBlocks);
  }
  return this;
}
